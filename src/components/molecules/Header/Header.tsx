          ...
          <div className={styles['header__top__container']}>
            <div className={styles['header__top__container__info-box']}>
              <InfoCard
                ...
                icon={<Image src="/icons/watch_icon.svg" alt="Watch icon" width={20} height={20} />}
              />
              <InfoCard
                title="+880 1630 225 015"
                icon={<Image src="/icons/phone_icon.svg" alt="Phone icon" width={20} height={20} />}
              />
            </div>
            <Link href="/signup" className={styles['header__top__container__link']}>
              Register
            </Link>
          </div>
        </MainContainer>
        ...
        <MainContainer>
          <div className={styles['header__bottom__container']}>
            ...
            <div className={styles['header__bottom__container__info-box']}>
              ...
              <Link href="/login" className={styles['header__bottom__container__info-box__link']}>
                Login
              </Link>
            </div>
          </div>
